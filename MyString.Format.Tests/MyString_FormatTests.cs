...
{
	static readonly IFormatProvider formatProvider = CultureInfo.CreateSpecificCulture("en-US");
	...
	public string FormatTest_OneArg(string format, object arg0)
		=> new MyStringFormatter(formatProvider, format).Format(arg0);
	...
	public string FormatTest_TwoArg(string format, object arg0, object arg1)
		=> new MyStringFormatter(formatProvider, format).Format(arg0, arg1);
	...
	public string FormatTest_ThreeArg(string format, object arg0, object arg1, object arg2)
		=> new MyStringFormatter(formatProvider, format).Format(arg0, arg1, arg2);
	...
	public string FormatTest_FourArg(string format, object arg0, object arg1, object arg2, object arg3)
		=> new MyStringFormatter(formatProvider, format).Format(new object[] { arg0, arg1, arg2, arg3 });
}
